...
# Load sound effects
brick_hit_sound = pygame.mixer.Sound("Techcraft-NeuralNetNinjas\Water Drop Sound.wav")
game_over_sound = pygame.mixer.Sound("Techcraft-NeuralNetNinjas\music.wav")
    ...
    if not game_over:
        ...
        for brick, brick_color in bricks[:]:
            if ball.colliderect(brick):
                ...
                ball_speed[1] = -ball_speed[1]
                score += 10
                brick_hit_sound.play()  # Play the brick hit sound
